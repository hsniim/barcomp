...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const maxAge = formData.rememberMe ? 2592000 : 86400; // 30 days or 1 day
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ paddingBottom: '3rem' }}>
        {/* Background effects */}
